...
const FlashcardsGame: React.FC<FlashcardsGameProps> = ({ words: allWords, language, languageName, onClose }) => {
  ...
  const { currentMessage, showOverlay, checkProgress, resetProgress, dismissOverlay } = useSessionProgress(20);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-100 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div
          onClick={handleFlip}
          className="bg-white rounded-lg shadow-lg p-12 mb-6 cursor-pointer hover:shadow-xl transition-shadow min-h-[300px] flex items-center justify-center"
        >
