...
const MeaningMatchGame: React.FC<MeaningMatchGameProps> = ({ words: allWords, language, languageName, onClose }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <p className="text-3xl font-bold text-blue-600 mb-6">{currentWord.english}</p>
