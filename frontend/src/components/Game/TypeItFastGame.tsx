...
export default function TypeItFastGame({ words, language, onClose }: TypeItFastGameProps) {
  ...
  const handleTimeout = () => {
    setIsAnswered(true);
    setStreak(0);
    toast.error(`Time's up! The English word was: ${currentWord.english}`, { duration: 2000 });
  ...
  const handleSubmit = useCallback(() => {
    ...
    if (correct) {
      ...
      setStreak(0);
      toast.error(`Wrong! The English word was: ${currentWord.english}`, { duration: 2000 });
    }
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-8 space-y-4">
              <p className="text-muted-foreground">No English words available for the selected difficulty.</p>
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Type the English word for {language.name} meanings</p>
        </div>
      </div>
