...
const GapFillGame: React.FC<GapFillGameProps> = ({ words: allWords, language, languageName, onClose }) => {
  ...
  useEffect(() => {
    if (allWords.length > 0) {
      ...
      const wordsWithExamples = filtered.filter((w) => w.examples && w.examples.length > 0);
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            There are not enough words with examples for the selected difficulty level.
          </p>
          <button
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-xl font-bold text-gray-800">Gap-Fill Sentence</h1>
            <button
              onClick={handleBackClick}
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Fill in the blank:</h2>
          <p className="text-xl text-gray-800 mb-4 leading-relaxed">{gappedSentence}</p>
