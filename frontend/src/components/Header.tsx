      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between max-w-7xl">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          >
            Home
            {isActive('/') && (
              <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-primary dark:bg-white"></span>
            )}
          </button>
          <button
          ...
          <button
            ...
            className={`text-sm font-medium transition-colors hover:text-primary relative pb-1 flex items-center gap-1.5 ${
              isActive('/feedback') ? 'text-primary dark:text-white' : 'text-muted-foreground dark:text-gray-400'
            }`}
          >
          ...
          <nav className="container mx-auto px-4 py-4 flex flex-col gap-3">
            <button
              ...
              className={`text-left px-4 py-2 rounded-lg transition-colors ${
                isActive('/') ? 'bg-purple-100 dark:bg-gray-800 text-primary dark:text-white font-medium' : 'text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-gray-800'
              }`}
            >
              Home
            </button>
            <button
              ...
              className={`text-left px-4 py-2 rounded-lg transition-colors flex items-center gap-2 ${
                isActive('/analytics') ? 'bg-purple-100 dark:bg-gray-800 text-primary dark:text-white font-medium' : 'text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-gray-800'
              }`}
            >
              <BarChart3 className="w-4 h-4" />
              Analytics
            ...
            <button
              ...
              className={`text-left px-4 py-2 rounded-lg transition-colors flex items-center gap-2 ${
                isActive('/feedback') ? 'bg-purple-100 dark:bg-gray-800 text-primary dark:text-white font-medium' : 'text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-gray-800'
              }`}
            >
              <MessageSquare className="w-4 h-4" />
              Feedback
