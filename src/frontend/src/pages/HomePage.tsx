    ...
    return (
      <div className="flex items-center justify-center min-h-screen p-4">
        <Alert className="max-w-md">
          ...
          <AlertDescription>
            Failed to load languages. Please refresh the page or contact
            support.
            <br />
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-900 dark:via-purple-900 dark:to-gray-900">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="glass-card rounded-2xl p-8 mb-8 text-center shadow-lg">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Players improve their English by progressing through multiple
            difficulty levels and learning new words through gameplay.
          </p>
          ...
          {sortedLanguages.length === 0 ? (
            <Alert className="bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800">
              ...
              <AlertDescription className="text-amber-800 dark:text-amber-200">
                ...
                <br />
                An administrator needs to set up languages first. Please contact
                your administrator or visit the admin panel to create languages.
              </AlertDescription>
            </Alert>
          ) : (
