          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-8">
            <div className="flex items-center justify-between">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                ...
                <strong>Log in to track your personal progress!</strong>{" "}
                Anonymous users can view global statistics only.
              </p>
              <Button
                onClick={login}
                size="sm"
                ...
                <div className="glass-card rounded-xl p-6 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {global.averageAccuracy.toFixed(1)}%
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="glass-card rounded-xl p-6 shadow-lg">
                <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Detailed performance metrics per game mode will be available
                    in a future update.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="glass-card rounded-xl p-6 shadow-lg">
                <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Detailed performance metrics per language will be available
                    in a future update.
                  </p>
                </div>
              </div>
