...
import type { DifficultySelector as DifficultySelectorType } from "../../backend";
import { useInternetIdentity } from "../../hooks/useInternetIdentity";
import {
  useGetCallerUserPreferences,
  useUpdateCallerUserPreferences,
  ...
  return (
    <div className={className}>
      <label
        ...
        className="text-sm font-bold mb-3 block text-foreground uppercase tracking-wide"
      >
        Difficulty Level
      </label>
