...
export default function MemoryMatchGame({
  ...
  const gameWords = useMemo(() => {
    return [...filteredWords]
      ...
      .slice(0, Math.min(8, filteredWords.length));
  }, [filteredWords]);
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8 space-y-4">
              <p className="text-muted-foreground">
                Not enough words for the selected difficulty. At least 2 words
                are required.
              </p>
              <DifficultySelector
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Match English with {language.name}
            </p>
          </div>
        </div>
          ...
          >
            <CardContent className="p-6 h-32 flex items-center justify-center">
              {card.isFlipped || card.isMatched ? (
                <p className="text-center font-semibold text-sm break-words">
                  {card.text}
                </p>
              ) : (
